...
<body>
    <nav class="navbar  py-lg-2">
        <div class="container d-flex align-items-center justify-content-center">
            <a class="navbar-brand" href="{{ url('/') }}">
                <img src="{{ asset('assets/frontend/images/dolan-header.png') }}" width="100">
            </a>
        </div>
    </nav>
    ...
    <div class="container mt-5">
        <div class="row m-0 justify-content-center">
            <div class="col-lg-10 p-0">
                <nav class="bg-white py-4 mb-5 rounded-12" style="--bs-breadcrumb-divider: '>';"
                    aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 justify-content-evenly align-items-center">
                        <li class="breadcrumb-item d-flex align-items-center">
                            <button
                                class="btn py-1 px-2 shadow-none text-sm text-white fw-bolder me-3 {{ $active == 'fill-in-data' ? 'bgColor' : 'bg-secondary-light' }}">1</button>
                            <h6 class="fw-bold m-0 {{ $active == 'fill-in-data' ? '' : 'text-secondary-light' }}">Isi
                                Data</h6>
                        </li>

                        <li class="breadcrumb-item d-flex align-items-center">
                            <button
                                class="btn py-1 px-2 shadow-none text-sm text-white fw-bolder me-3 {{ $active == 'review' ? 'bgColor' : 'bg-secondary-light' }}">2</button>
                            <h6 class="fw-bold m-0 {{ $active == 'review' ? '' : 'text-secondary-light' }}">Review
                            </h6>
                        </li>
                        <li class="breadcrumb-item d-flex align-items-center">
                            <button
